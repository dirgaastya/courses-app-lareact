        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <li className="lg:mt-3 px-2 lg:p-2">
                        <SideNavLink
                            href={route("course.dashboard")}
                            active={route().current("course.dashboard")}
                        >
                    ...
                    <li className="lg:mt-3 px-2 lg:p-2">
                        <SideNavLink
                            href={route("transaction.dashboard")}
                            active={route().current("transaction.dashboard")}
                        >
                    ...
                    <li className="lg:mt-3 px-2 lg:p-2">
                        ...
                        >
                            ...
                            <span className="text-xs lg:mt-2">Profile</span>
                        </SideNavLink>
                    </li>
                </ul>
